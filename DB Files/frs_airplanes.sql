...
CREATE TABLE `airplanes` (
  ...
  `airplanename` varchar(80) NOT NULL,
  `seats` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `airplanename_UNIQUE` (`airplanename`)
...
INSERT INTO `airplanes` VALUES (1,'Airbus 380',500),(2,'Boeing 747',300),(3,'Boeing 737',200);
